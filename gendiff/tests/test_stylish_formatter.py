...
def test_normal_scenario_json_format(file1_json, file2_json):
    ...
    path_to_expected = "gendiff/tests/test_data/file1_file2_expected.txt"
...
def test_with_empty_file_json_format(file1_json):
    empty_json_path = "gendiff/tests/test_data/empty.json"

    path_to_expected = "gendiff/tests/test_data/file1_and_empty_expected.txt"
    with open(path_to_expected) as file:
        expected = file.read()
        actual = stylish(file1_json, empty_json_path)
        assert actual == expected

    path_to_expected = "gendiff/tests/test_data/empty_and_file1_expected.txt"
...
def test_complex_json_file(complex_json_file1, complex_json_file2):
    path_to_expected = "gendiff/tests/test_data/complex_diff.txt"
    with open(path_to_expected) as file:
        expected = file.read()
